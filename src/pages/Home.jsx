        ...
        <div className="contact-content">
          <div className="contact-left animate-in">
            ...
            <div className="contact-items">
              ...
              <a className="contact-item" href="https://www.instagram.com/aarunya_sparsha_foundation" target="_blank" rel="noreferrer">
                <div className="contact-item-icon">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a className="contact-item" href="https://www.facebook.com/Aarunyasparshafoundation" target="_blank" rel="noreferrer">
                <div className="contact-item-icon">
          ...
          <div className="footer-top">
            <div className="footer-brand">
              ...
              <div className="footer-social">
                <a href="https://www.facebook.com/Aarunyasparshafoundation" target="_blank" rel="noreferrer" aria-label="Facebook">
                ...
                <a href="https://www.instagram.com/aarunya_sparsha_foundation" target="_blank" rel="noreferrer" aria-label="Instagram">
